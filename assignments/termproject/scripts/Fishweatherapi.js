...
//Forecast
	...
	weatherForecast.open('Get', 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=b47f2cab33c690b0345b5ace29342cc2', true);
...
function showTown(jsonObj) {
  ...
  for (var i = 0; i < info.length; i++){
	  if ((info[i].name == 'Fish Haven') == false){
	  continue;	
  }
